...
def create_dhs_dataframe(source_path, save_csv=True):
    """
    ...
    If some of the DHS variables are not available then we will not generate our poverty DataFrame
    DHS dataframe is saved as dhs_variables.csv
    ...
    Returns:
        df, bool (DataFrame, bool): The DHS DataFrame and, a flag to whether a poverty DataFrame should be created
